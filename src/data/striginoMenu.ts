export const mainMenu: MenuPropsType = [
  {
    title: 'Салаты',
    content: [
      {
        dishName: 'Сытное Стригино',
        desc: 'Отварная говядина, ветчина, томат свежий, айсберг, брынза, соус',
        weight: '200 г.',
        price: 435,
      },
      {
        dishName: 'Греческий',
        desc: 'Перец сладкий, томат свежий, огурец, зелень салата, лук маринованный, сыр фета',
        weight: '200 г.',
        price: 315,
      },
      {
        dishName: 'Цезарь с курицей',
        desc: 'Куриное филе, сыр, салат айсберг, томаты черри, сухари пшеничные, заправка.',
        weight: '200 г.',
        price: 365,
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        dishName: 'Эскалоп с картофелем',
        desc: 'Мясо свинина, картофель по-деревенски, соленый огурчик',
        weight: '100/120/30',
        price: 525,
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      {
        dishName: 'Манты',
        desc: 'Соус кисло-сладкий с морковью',
        weight: '200/50 г.',
        price: 360,
      },
      {
...
export const banquetMenu: MenuPropsType = [
  {
...
export const drinkMenu: MenuPropsType = [
  {
    title: 'Напитки',
    content: [
      {
