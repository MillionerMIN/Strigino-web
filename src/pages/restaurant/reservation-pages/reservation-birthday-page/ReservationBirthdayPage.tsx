import './reservationBirthdayPage.scss';
...
const ReservationBirthdayPage = () => {
  ...
  return (
    <div className="reservation-restaurant-page reservation-restaurant-page_pd">
      <HeadingBlock
        data={{
          title: content.eventsRes[1].reservation?.titleReserve,
          photo: content.eventsRes[1].photos[0],
        }}
      />
      <div className="container">
        <BlockTitle
          data={{ title: content.eventsRes[1].reservation?.present.title }}
        />
...
export default ReservationBirthdayPage;
